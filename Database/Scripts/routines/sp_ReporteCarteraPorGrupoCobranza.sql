    ...
    FROM (
        ...
        WHERE
            ...
            /* ============================================================
               ...
               ============================================================ */
            AND (
                /* Si no existe, pasa normal */
                NOT EXISTS (
                    SELECT 1
                    FROM bitacora.bitacora_bajas bb
                    WHERE bb.ClienteId = Socios.S_CLAVE
                      AND bb.creditoId = Prestamo.PQ_CLAVE
                )
                OR 
                /* Si existe, que tenga estatus 4 */
                EXISTS (
                    SELECT 1
                    FROM bitacora.bitacora_bajas bb
                    WHERE bb.ClienteId = Socios.S_CLAVE
